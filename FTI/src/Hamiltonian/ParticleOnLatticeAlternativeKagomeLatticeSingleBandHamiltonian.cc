...
ParticleOnLatticeAlternativeKagomeLatticeSingleBandHamiltonian::ParticleOnLatticeAlternativeKagomeLatticeSingleBandHamiltonian(ParticleOnSphere* particles, int nbrParticles, int nbrSiteX, int nbrSiteY,
        Abstract2DTightBindingModel* tightBindingModel, double uPotential, double vPotential, int bandIndex, bool flatBandFlag, AbstractArchitecture* architecture, long memory)
{
