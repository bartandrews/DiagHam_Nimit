...
int main(int argc, char** argv)
{
    ...
    ofstream Command;
    Command.open ("Command.txt", ios::out | ios::app);
    Command << "\n============================ Begin =============================" << '\n';
    ...
    ofstream FullOption;
    FullOption.open ("FullOption.txt", ios::out | ios::app);
    FullOption << "\n============================ Begin =============================" << '\n';
    ...
    int TmpIndex = 0;
    int** TotalIndex = new int* [NbrStateX];
    ...
    int OriginX = NbrStateX - 1;
    int OriginY = NbrStateY - 1;
