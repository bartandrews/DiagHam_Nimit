...
int main(int argc, char** argv)
{
    ...
    {
    case 1:
        cout << "The output format is: X for lines and Y for columns\n";
        break;
    case 2:
        cout << "The output format is: Z for lines and Y for columns\n";
        exchange = M;
        M = P;
        P = exchange;
        break;
    case 3:
        cout << "The output format is: X for lines and Z for columns\n";
        exchange = N;
        N = P;
        P = exchange;
        break;
        ...
        for (int j = 0; j < N1; ++j)
            for (int k = 0; k < P1; ++k)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    Coefficients >> Coef[k][j][i];
                    break;
                default:
                    Coefficients >> Coef[i][k][j];
                    break;
                }
            }
