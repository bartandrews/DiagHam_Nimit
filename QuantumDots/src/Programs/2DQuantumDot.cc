...
int main(int argc, char** argv)
{
    ...
    int NbrStateX = NbrCellX;
    int NbrStateY = NbrCellY;
    int MinX = LeftX * NbrCellX;
    int MaxX = (1.0 - RightX) * NbrCellX;
    int MinY = LeftY * NbrCellY;
    int MaxY = (1.0 - RightY) * NbrCellY;
    ...
    delete[] ElementaryCouplingX;
    delete[] ElementaryCouplingY;
    delete[] Intermediate;
