...
void PeriodicElectronHole3DHamiltonian::MakeConversionTable ()
{
    ...
    int LengthX1 = this->NbrState1X * 2 - 1;
    int LengthY1 = this->NbrState1Y * 2 - 1;
    int LengthZ1 = this->NbrState1Z * 2 - 1;
    int OriginX1 = this->NbrState1X - 1;
    int OriginY1 = this->NbrState1Y - 1;
    int OriginZ1 = this->NbrState1Z - 1;
    ...
    int LengthX2 = this->NbrState2X * 2 - 1;
    int LengthY2 = this->NbrState2Y * 2 - 1;
    int LengthZ2 = this->NbrState2Z * 2 - 1;
    int OriginX2 = this->NbrState2X - 1;
    int OriginY2 = this->NbrState2Y - 1;
    int OriginZ2 = this->NbrState2Z - 1;
...
void PeriodicElectronHole3DHamiltonian::EvaluateKineticTerm (double mex, double mey, double mez, double mhx, double mhy, double mhz, PeriodicThreeDOneParticle* firstParticle, PeriodicThreeDOneParticle* secondParticle, double xSize, double ySize, double zSize)
{
    ...
    double* factorX1 = new double [this->NbrState1X];
    double* factorY1 = new double [this->NbrState1Y];
    double* factorZ1 = new double [this->NbrState1Z];
    double* factorX2 = new double [this->NbrState2X];
    double* factorY2 = new double [this->NbrState2Y];
    double* factorZ2 = new double [this->NbrState2Z];
    ...
    int index = 0;
    double FactorX1, FactorY1, FactorZ1, FactorX2, FactorY2;
    for (int m1 = 0; m1 < this->NbrState1X; ++m1)
    {
...
void PeriodicElectronHole3DHamiltonian::EvaluateConfinementTerm (ThreeDConstantCellPotential* potential, PeriodicThreeDOneParticle* particle, double* &realConfinement, double* &imaginaryConfinement)
{
    ...
    int LengthX = (NbrStateX - 1) * 2 + 1;
    int LengthY = (NbrStateY - 1) * 2 + 1;
    int LengthZ = (NbrStateZ - 1) * 2 + 1;
    ...
    delete[] RealWaveFunctionOverlapX;
    delete[] RealWaveFunctionOverlapY;
    delete[] RealWaveFunctionOverlapZ;
    delete[] ImaginaryWaveFunctionOverlapX;
    delete[] ImaginaryWaveFunctionOverlapY;
    delete[] ImaginaryWaveFunctionOverlapZ;
    delete[] TmpReal;
    delete[] TmpImaginary;
}
