            ...
            for (m2 = 0; m2 < m1; ++m2)
            {
                for (n2 = 0; n2 < n1; ++n2)
                {
                    ...
                    for (p1 = 0; p1 < this->NbrStateZ; ++p1)
                    {
                        ...
                        VSourceRe1 = vSource.Re(Index1);
                        VSourceIm1 = vSource.Im(Index1);
                        VSourceRe3 = vSource.Re(Index3);
                        VSourceIm3 = vSource.Im(Index3);
                        VSourceRe5 = vSource.Re(Index5);
                        VSourceIm5 = vSource.Im(Index5);
                        VSourceRe7 = vSource.Re(Index7);
                        VSourceIm7 = vSource.Im(Index7);
                        ...
                        vDestination.Re(Index1) += TmpTotalRe1;
                        vDestination.Im(Index1) += TmpTotalIm1;
                        vDestination.Re(Index3) += TmpTotalRe3;
                        vDestination.Im(Index3) += TmpTotalIm3;
                        vDestination.Re(Index5) += TmpTotalRe5;
                        vDestination.Im(Index5) += TmpTotalIm5;
                        vDestination.Re(Index7) += TmpTotalRe7;
                        vDestination.Im(Index7) += TmpTotalIm7;
