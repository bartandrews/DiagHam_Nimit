...
bool FQHETorusSU2GetPseudopotentials (char* fileName, int* nbrPseudoPotentials, double** pseudoPotentials)
{
    ...
    else if (InteractionDefinition["Pseudopotentials"] != 0)
    {
        cout << "Pseudopotentials has a wrong value in " << fileName << endl;
        return false;
    }
    ...
    else if (InteractionDefinition["PseudopotentialsUpUp"] != 0)
    {
    ...
    else if (InteractionDefinition["PseudopotentialsDownDown"] != 0)
    {
    ...
    else if (InteractionDefinition["PseudopotentialsUpDown"] != 0)
    {
...
bool FQHETorusSU3GetPseudopotentials (char* fileName, int* nbrPseudoPotentials, double** pseudoPotentials)
{
    ...
    else if (InteractionDefinition["Pseudopotentials11"] != 0)
    {
    ...
    else if (InteractionDefinition["Pseudopotentials12"] != 0)
    {
    ...
    else if (InteractionDefinition["Pseudopotentials13"] != 0)
    {
    ...
    else if (InteractionDefinition["Pseudopotentials22"] != 0)
    {
    ...
    else if (InteractionDefinition["Pseudopotentials23"] != 0)
    {
    ...
    else if (InteractionDefinition["Pseudopotentials33"] != 0)
    {
...
bool FQHETorusSU4GetPseudopotentials (char* fileName, int* nbrPseudoPotentials, double** pseudoPotentials)
{
    ...
    else if (InteractionDefinition["PseudopotentialsUpPlusUpPlus"] != 0)
    {
    ...
    else if (InteractionDefinition["PseudopotentialsUpPlusUpMinus"] != 0)
    {
    ...
    else if (InteractionDefinition["PseudopotentialsUpPlusDownPlus"] != 0)
    {
    ...
    else if (InteractionDefinition["PseudopotentialsUpPlusDownMinus"] != 0)
    {
    ...
    else if (InteractionDefinition["PseudopotentialsUpMinusUpMinus"] != 0)
    {
    ...
    else if (InteractionDefinition["PseudopotentialsUpMinusDownPlus"] != 0)
    {
    ...
    else if (InteractionDefinition["PseudopotentialsUpMinusDownMinus"] != 0)
    {
    ...
    else if (InteractionDefinition["PseudopotentialsDownPlusDownPlus"] != 0)
    {
    ...
    else if (InteractionDefinition["PseudopotentialsDownPlusDownMinus"] != 0)
    {
