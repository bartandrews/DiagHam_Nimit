...
// UpUpUpUp Sector
        ...
        else if (InteractionDefinition["PseudopotentialsUpUpUpUp"] != 0)
        {
...
// UpDownUpUp Sector
        ...
        else if (InteractionDefinition["PseudopotentialsUpDownUpUp"] != 0)
        {
...
// DownDownUpUp Sector
        ...
        else if (InteractionDefinition["PseudopotentialsDownDownUpUp"] != 0)
        {
...
// UpUpUpDown Sector
        ...
        else if (InteractionDefinition["PseudopotentialsUpUpUpDown"] != 0)
        {
...
// UpDownUpDown Sector
        ...
        else if (InteractionDefinition["PseudopotentialsUpDownUpDown"] != 0)
        {
...
// DownUpUpDown Sector
        ...
        else if (InteractionDefinition["PseudopotentialsDownUpUpDown"] != 0)
        {
...
// DownDownUpDown Sector
        ...
        else if (InteractionDefinition["PseudopotentialsDownDownUpDown"] != 0)
        {
...
// UpUpDownDown Sector
        ...
        else if (InteractionDefinition["PseudopotentialsUpUpDownDown"] != 0)
        {
...
// UpDownDownDown Sector
        ...
        else if (InteractionDefinition["PseudopotentialsUpDownDownDown"] != 0)
        {
...
// DownDownDownDown Sector
        ...
        else if (InteractionDefinition["PseudopotentialsDownDownDownDown"] != 0)
        {
