...
int main(int argc, char** argv)
{
    ...
    else
    {
        ...
        else if (InteractionDefinition["ThreebodyPseudopotentials"] != 0)
        {
        ...
        else if (InteractionDefinition["ThreebodyPseudopotentialsUpUpUp"] != 0)
        {
        ...
        else if (InteractionDefinition["ThreebodyPseudopotentialsDownDownDown"] != 0)
        {
        ...
        else if (InteractionDefinition["ThreebodyPseudopotentialsUpUpDown"] != 0)
        {
        ...
        else if (InteractionDefinition["ThreebodyPseudopotentialsDownDownUp"] != 0)
        {
