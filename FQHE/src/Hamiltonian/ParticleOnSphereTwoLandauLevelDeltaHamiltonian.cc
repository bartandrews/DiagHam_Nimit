        ...
        AbstractArchitecture* architecture, long memory, bool onDiskCacheFlag, char* precalculationFileName, bool showIntFactorsFlag)
{
    ...
    if ( pseudoPotential != NULL )
    {
        ...
        this->NbrPseudoPotentialCoeffs[0] = this->LzMaxUp + 1;
        this->PseudoPotentialMins[0] = 0;
        this->NbrPseudoPotentialCoeffs[1] = this->LzMaxUp - 1;
        this->PseudoPotentialMins[1] = 0;
        this->NbrPseudoPotentialCoeffs[2] = this->LzMaxUp - 1;
        this->PseudoPotentialMins[2] = 1;
        this->NbrPseudoPotentialCoeffs[3] = this->LzMaxUp - 1;
        this->PseudoPotentialMins[3] = 0;
        this->NbrPseudoPotentialCoeffs[4] = this->LzMaxUp - 1;
        this->PseudoPotentialMins[4] = 0;
        this->NbrPseudoPotentialCoeffs[5] = this->LzMaxUp - 2;
        this->PseudoPotentialMins[5] = 1;
        this->NbrPseudoPotentialCoeffs[6] = this->LzMaxUp - 1;
        this->PseudoPotentialMins[6] = 1;
        this->NbrPseudoPotentialCoeffs[7] = this->LzMaxUp - 2;
        this->PseudoPotentialMins[7] = 1;
        this->NbrPseudoPotentialCoeffs[8] = this->LzMaxUp - 1;
        this->PseudoPotentialMins[8] = 1;
